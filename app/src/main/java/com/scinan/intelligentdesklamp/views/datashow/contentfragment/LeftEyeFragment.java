...
import com.scinan.intelligentdesklamp.views.datashow.adapter.LeftEyeDataAdapter;
...
public class LeftEyeFragment extends BaseFragment implements View.OnClickListener {
    int x = R.layout.fragment_left_eye;
    @Bind(R.id.tv_1)
    TextView tv1;
    @Bind(R.id.tv_2)
    TextView tv2;
    ...
    private List<LeftEyeDataBean> leftEyeDataBeans = new ArrayList<>();
    private LeftEyeDataAdapter leftEyeDataAdapter;
    ...
    public void initData() {
        ...
        initBeans();
        leftEyeDataAdapter = new LeftEyeDataAdapter(leftEyeDataBeans, mContext, R.layout.item_lefteyedata);
        listview.setAdapter(leftEyeDataAdapter);
        leftEyeDataAdapter.notifyDataSetChanged();
    }

    @Override
    public int getLayoutId() {
        return R.layout.fragment_left_eye;
    }

    private void initBeans() {
        for (int i = 0; i < 4; i++) {
            LeftEyeDataBean leftEyeDataBean = new LeftEyeDataBean();
            leftEyeDataBean.setTime("2019/07/06 21:0" + i);
            leftEyeDataBean.setVision("视力：5.1(1." + i + ")");
            leftEyeDataBeans.add(leftEyeDataBean);
        }
    }
