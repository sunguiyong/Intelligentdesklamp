...
public class SittingPostureFragment extends BaseFragment implements View.OnClickListener {
    int x = R.layout.fragment_content_sittingposture;
    @Bind(R.id.tv_1)
    TextView tv1;
    @Bind(R.id.tv_2)
    TextView tv2;
    ...
    public int getLayoutId() {
        return R.layout.fragment_content_sittingposture;
    }
